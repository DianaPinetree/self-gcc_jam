...
public class Utils : MonoBehaviour
{
    ...
    public static List<PickUp> GetXPInSpatialGroups(List<int> spatialGroups)
    {
        List<PickUp> xp = new List<PickUp>();

        foreach (int spatialGroup in spatialGroups)
        {
            xp.AddRange(GameController.instance.pickupsSpacialGroup[spatialGroup]);
        }
    ...
    public static long GetExperienceRequired(int currentLevel)
    {
        ...
        {
            0, 10, 34, 56, 73, 105, 145, 192, // 1 - 10ha
